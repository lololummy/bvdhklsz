...
label = Label(root, text="Internet Speed Check", font=("Lucisa Sans Unicode", 20, 
"bold","italic"),fg="#5D6D7E", bg="#dee8f1")
label.place(relx=0.5, rely=0.1,anchor=CENTER)

label_download = Label(root, text="Download Speed", font=("Segoe Print", 18,
 "bold"),fg="#1E8449", bg="#dee8f1")
label.place(relx=0.25, rely=0.5,anchor=CENTER)

label_upload = Label(root, text="Upload Speed", font=("Segoe Print", 18,
 "bold"),fg="#1E8449", bg="#dee8f1")
label.place(relx=0.75, rely=0.5,anchor=CENTER)

label_download_speed = Label(root, font=("Yu Gothic Light", 14,
 "bold"),bg="#dee8f1")
label.place(relx=0.25, rely=0.6,anchor=CENTER)

label_upload_speed = Label(root, font=("Yu Gothic Light", 14,
 "bold"),bg="#dee8f1")
